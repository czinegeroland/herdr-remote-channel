...
| Last updated | 2026-09-24T03:50:00+02:00 |
| Product owner | TBD |
| Technical owner | TBD |
...
names. Messages are ordered by identifier where it is a ULID, so a reply sits
under what it answers; an inbound identifier is sender-chosen and only
shape-checked, so this orders the reading and decides nothing.
