...
| Last updated | 2026-09-14T05:20:00+02:00 |
| Product owner | TBD |
| Technical owner | TBD |
...
| M3 Herdr integration | 99% | The daemon now stops on Ctrl-C or SIGTERM instead of only being killable, releasing both endpoints so a restart is immediate; that closes the last technical row beneath the implementation umbrella | Daemon cancellation | Cut a first tag so published artifacts are proven |
