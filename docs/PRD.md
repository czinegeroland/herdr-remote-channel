...
| Last updated | 2026-09-14T06:40:00+02:00 |
| Product owner | TBD |
| Technical owner | TBD |
...
| M3 Herdr integration | 100% | `cargo dist` now owns the release pipeline as DEC-015 named, verified by running the real tool: it plans the four required targets, builds a checksum-verified artifact, and excludes the conformance fixture it was silently packaging | cargo-dist adoption | Cut a first tag so the Windows and macOS artifacts exist |
