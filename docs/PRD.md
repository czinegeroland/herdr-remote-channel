...
| Last updated | 2026-09-13T22:11:01+02:00 |
| Product owner | TBD |
| Technical owner | TBD |
...
| M3 Herdr integration | 85% | The shipped skill now permits agents to create context drafts while reserving sensitive disclosure decisions to the local human | Context draft-only skill boundary | Build the trusted approval TUI, then the Herdr inbox UI |
